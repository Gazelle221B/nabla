				...
				<>
					...
					<div className={styles.checkpoint}>
						...
						<p className={styles.narration}>
							...
							と同じ計算です——設定を変えると、合計や本数の変化に応じて期待値も変わります(逆に、
							合計が変わらない変え方——たとえば本数が0本の等級の賞金額だけを変える——では期待値は
							動きません。期待値が「実際に入っているくじ」だけで決まることの裏返しです)。試行回数 n を大きくスライダーで動かして、標本平均が期待値へ近づいて
